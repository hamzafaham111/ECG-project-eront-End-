...
const Auth = () => {
    ...
    const [tabColor2, setTabColor2] = useState({
        color: "#00caff",
        borderBottom: "solid #00caff  0.1em",
        border: "solid #00caff 3px"
    })
    const handleChang = () => {
        state ? setState(false) : setState(true)
        !state ? setTabColor({ color: "#9d9d9d", borderBottom: "solid transparent  0.1em", border: "solid transparent 3px" }) : setTabColor({ color: "#00caff", borderBottom: "solid #00caff  0.1em", border: "solid #00caff 3px" })
        !state ? setTabColor2({ color: "#00caff", borderBottom: "solid #00caff  0.1em", border: "solid #00caff 3px" }) : setTabColor2({ color: "#9d9d9d", borderBottom: "solid transparent  0.1em", border: "solid transparent 3px" })
